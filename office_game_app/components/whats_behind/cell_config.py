        ...
        rx.hstack(
            rx.vstack(
                ...
                rx.vstack(
                    ...
                    rx.slider(
                        min=3, max=15, value=[state.num_rows], on_change=state.set_num_rows.throttle(20), width="200px"
                    ),
                ),
                rx.vstack(
                    rx.text("Number of Columns"),
                    rx.slider(
                        min=3, max=15, value=[state.num_cols], on_change=state.set_num_cols.throttle(20), width="200px"
                    ),
                ),
